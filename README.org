...
*Here add description about what the installation looks like and how it works - briefly. Also, what its components are - BCI, computer, speakers, projector.  And how the user uses it*
